    ...
    *,
    ...
    async def _run_and_close():
        ...
        try:
            ...
            # Native initialization can perform provider/memory I/O. Keep the
            # HTTP event loop available to admit, list and cancel follow-ups.
            construction = asyncio.create_task(asyncio.to_thread(_construct_agent))
            try:
